...
area_block_data = [
    {"area_code": area.area_code, "area_name": area.area_name} for area in area_block
]

prefecture_data = [
    {
        "area_code": prefecture.area_code,
...
json_data = {"areas": area_block_data, "prefectures": prefecture_data}

with open("japan_regions.json", "w") as f:
